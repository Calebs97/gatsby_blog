        ...
        <Main>
          <Helmet title="This Site" />
            <section id="one">
              ...
              <h3>Intro </h3>
              <p>I wanted to document my journey in creating this website and give credit to many of the resources/examples I utilized.
              ...
              <ul>
                ...
                <li>Joshua Cho my roommate for making me the favicon</li>
                <li>Many articles and google searches</li>
              </ul>

              <h3> To-do List</h3>
              <ul>
                <li>Make the links on my homepage fast (figure out how to make Link Buttons)</li>
                ...
                <li>Clicking on my picture on the sidebar should do something besides go to home page</li>
